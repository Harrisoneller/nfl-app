// Auth context — ported from the web app's AuthProvider, adapted to RN's async
// token storage. Hydrates the SecureStore token at boot before deciding the
// authenticated state.
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    // Load persisted token first, then validate it against /auth/me.
    hydrateToken()
      .then(() => refresh())
